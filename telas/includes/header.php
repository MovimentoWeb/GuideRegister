<header id="header-menu" class="navbar navbar-fixed-top navbar-inverse">
    <div class="navbar-inner">
        <div class="container">
            ...
            <a class="brand" href="#"><span class="fa-home3"></span> Guide Register</a>
            ...
            <div class="nav-collapse">
                ...
                <ul class="nav">
                    <div class="btn-group">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="dropdown-submenu">
                                <a tabindex="-1" href="#"><i class="fa-list-alt"></i> Listar</a>
                                <ul class="dropdown-menu">
                                    <li><a href="">Listas</a></li>
                ...
                <ul class="nav">
                    <div class="btn-group">
                        <a class="btn dropdown-toggle btn-inverse" data-toggle="dropdown" href="#">
                            <i class="fa-file-powerpoint icon-white"></i> Relatórios
                            <span class="caret"></span>
                        </a>
                        <ul class="dropdown-menu">
                            <!-- Links de menu dropdown -->

                            <li ><a href="?selecionar=relatorios">Pesquisar por aluno</a> </li>
                ...
                <ul class="nav">
                    <a class="btn btn-inverse" href=""><span class="fa-warning2"></span> Aviso</a> 
                </ul>  
            </div>
        </div>
    </div>
